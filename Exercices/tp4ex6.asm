...
main:
    ...
    mov ecx,0	; utilisé pour parcourir la chaine résultat
...
boucle:
    ...
    jmp next_digit	; on va ranger dl dans la chaine résultat
un:
    mov dl,'1'		; on met le caractère '1' dans dl 

next_digit:
    mov byte[chresult+ecx*BYTE],dl	; on range le caractère contenu dans dl dans la chaine résultat
